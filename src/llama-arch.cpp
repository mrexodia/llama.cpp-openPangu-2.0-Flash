...
static const std::map<llm_arch, const char *> LLM_ARCH_NAMES = {
    ...
    { LLM_ARCH_OPENPANGU_V2,     "openpangu-v2"     },
...
static const std::map<llm_kv, const char *> LLM_KV_NAMES = {
    ...
    { LLM_KV_ATTENTION_SINK_COUNT,                   "%s.attention.sink_count"                   },
    { LLM_KV_ATTENTION_CONV_KERNEL_SIZE,             "%s.attention.conv_kernel_size"             },
    { LLM_KV_ATTENTION_LAYER_SWA_WINDOW,             "%s.attention.layer_swa_window"             },
...
static const std::map<llm_tensor, const char *> LLM_TENSOR_NAMES = {
    ...
    { LLM_TENSOR_ATTN_Q_A_CONV,                          "blk.%d.attn_q_a_conv" },
    { LLM_TENSOR_ATTN_KV_A_CONV,                         "blk.%d.attn_kv_a_conv" },
    { LLM_TENSOR_ATTN_O_CONV,                            "blk.%d.attn_o_conv" },
    { LLM_TENSOR_ATTN_SINK_KV,                           "blk.%d.attn_sink_kv" },
    { LLM_TENSOR_ATTN_SINK_K_PE,                         "blk.%d.attn_sink_k_pe" },
...
static const std::map<llm_tensor, llm_tensor_info> LLM_TENSOR_INFOS = {
    ...
    {LLM_TENSOR_ATTN_Q_A_CONV,              {LLM_TENSOR_LAYER_REPEATING, GGML_OP_SSM_CONV}},
    {LLM_TENSOR_ATTN_KV_A_CONV,             {LLM_TENSOR_LAYER_REPEATING, GGML_OP_SSM_CONV}},
    {LLM_TENSOR_ATTN_O_CONV,                {LLM_TENSOR_LAYER_REPEATING, GGML_OP_SSM_CONV}},
    {LLM_TENSOR_ATTN_SINK_KV,               {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_ATTN_SINK_K_PE,             {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_BLOCK_POST_NORM,            {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
