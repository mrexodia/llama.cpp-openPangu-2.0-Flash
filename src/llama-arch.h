...
enum llm_kv {
    ...
    LLM_KV_ATTENTION_SINK_COUNT,
    LLM_KV_ATTENTION_CONV_KERNEL_SIZE,
    LLM_KV_ATTENTION_LAYER_SWA_WINDOW,
...
enum llm_tensor {
    ...
    LLM_TENSOR_ATTN_Q_A_CONV,
    LLM_TENSOR_ATTN_KV_A_CONV,
    LLM_TENSOR_ATTN_O_CONV,
    LLM_TENSOR_ATTN_SINK_KV,
    LLM_TENSOR_ATTN_SINK_K_PE,
    LLM_TENSOR_BLOCK_POST_NORM,
