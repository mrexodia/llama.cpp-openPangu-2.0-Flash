...
- Fused DSA indexer scoring at prefill (tiled `GGML_OP_DSA_SCORE` kernel that
  skips the multi-GB scoring intermediate) plus a radix-select top-k for
  `GGML_OP_TOP_K` — long-context prompt processing more than doubles
  (275 t/s at 100K, was 134)
...
|---|---|---|---|---|
| Prompt processing | n/a¹ | 666 t/s | 548 t/s | 275 t/s |
